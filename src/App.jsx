...
import ScribbleGame from './pages/ScribbleGame.jsx'
import ScribbleResult from './pages/ScribbleResult.jsx'
    ...
    <div className="min-h-dvh flex flex-col bg-background font-body text-white selection:bg-accent/40 selection:text-white">
      ...
      <main className="flex-grow flex flex-col relative z-10 w-full">
        <Routes>
          ...
          <Route path="/scribble/game/:roomCode" element={<ScribbleGame />} />
          <Route path="/scribble/result/:roomCode" element={<ScribbleResult />} />
